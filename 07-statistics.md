...
>>
Bayesian statistics considers prior knowledge when forming a probability distribution and will update the probability distribution when relevant new data comes to light. Frequentist statistics on the other hand only allow probability statements about sampling.
